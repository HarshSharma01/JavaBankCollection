...
public class MainUI {
	...
	static TransactionService trans = new TransactionServiceImpl();
	...
	private static void options(CustomerDetails u) {
		...
		while(true) {
			...
			case 1: System.out.println("Enter the amount to withdraw");
					...
					int balance = trans.withdraw(u.getAccountNo(), wAmt, u.getBalance());
					if(balance != 0)
					{
						if(balance != 1) {
			...
			case 2: System.out.println("Enter the amount to deposit");
					...
					int balance1 = trans.deposit(u.getAccountNo(), dAmt, u.getBalance());
					if(balance1 != 0)
					{
			...
			case 4: System.out.println("Enter the amount to transfer");
					...
					int details = trans.fundTransfer(u.getAccountNo(), toAccNo, tAmt);
					if(details != 0)
					{
